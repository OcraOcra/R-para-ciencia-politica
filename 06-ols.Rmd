...
```{r figure61, echo=FALSE, out.width='90%', fig.align='center', fig.cap="Mujeres en la legislatura estatal y proporcion de residentes cristianos"}
...
```{r figure62, echo=FALSE, out.width='90%', fig.align='center', fig.cap="Diagrama de dispersion con la recta de regresion"}
...
```{r figure63, echo=FALSE, out.width='90%', fig.align='center', fig.cap="Diagrama de dispersion con suavizador local"}
...
stargazer(model1, style = "qje", type = "text",
          dep.var.labels = c("Nota al gobierno"),
          covariate.labels = c("Apoyo al sistema", "Constante"),
...
model2 <- lm(as.numeric(nota_gob) ~ as.numeric(edad), data = ciep)
stargazer(model2, style = "qje", type = "text",
          dep.var.labels = c("Nota al gobierno"),
          covariate.labels = c("Edad", "Constante"),
          omit.table.layout = "n", digits = 3, report = ('vc*p'),
          omit.stat = c("ser", "f"))
```
...
model3 <- lm(as.numeric(nota_gob) ~ as.numeric(sexo), data = ciep)
stargazer(model3, style = "qje", type = "text",
          dep.var.labels = c("Nota al gobierno"),
          covariate.labels = c("Hombre (dummy)", "Constante"),
          omit.table.layout = "n", digits = 3, report = ('vc*p'),
          omit.stat = c("ser", "f"))
```
...
```{r model4, echo=FALSE, warning=FALSE, message=FALSE}
ciep$univ <- as.numeric(as.numeric(ciep$educarec) == 3)
model4 <- lm(as.numeric(nota_gob) ~ univ, data = ciep)
stargazer(model4, style = "qje", type = "text",
          dep.var.labels = c("Nota al gobierno"),
          covariate.labels = c("Universitaria (dummy)", "Constante"),
          omit.table.layout = "n", digits = 3, report = ('vc*p'),
          omit.stat = c("ser", "f"))
```
...
```{r model5, echo=FALSE, warning=FALSE, message=FALSE}
ciep$educ_f <- factor(ciep$educ_f, levels = c("Primaria o menos", "Secundaria", "Universitaria"))
model5 <- lm(as.numeric(nota_gob) ~ educ_f, data = ciep)
stargazer(model5, style = "qje", type = "text",
          dep.var.labels = c("Nota al gobierno"),
          covariate.labels = c("Secundaria", "Universitaria", "Constante"),
          omit.table.layout = "n", digits = 3, report = ('vc*p'),
          omit.stat = c("ser", "f"))
```
